...
export const defaultSupermarketProducts = [
  ...
  {
    id: 46,
    name: "Tropicana Mixed Fruit Juice Drink",
    brand: "Tropicana",
    category: "Beverages",
    price: 55.00,
    originalPrice: 70.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["500 ml Tetra Pack", "1 Litre Tetra Pack"],
    selectedVariant: "500 ml Tetra Pack",
    hasSpecialOffer: true,
    dealTag: "Vitamin C Rich 🧃",
    imageUrl: "https://images.unsplash.com/photo-1600271886742-f049cd451bba?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 47,
    name: "Coca-Cola Original Taste Chilled Cans",
    brand: "Coca-Cola",
    category: "Beverages",
    price: 40.00,
    originalPrice: 50.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["330 ml can", "Pack of 6 cans"],
    selectedVariant: "330 ml can",
    hasSpecialOffer: true,
    dealTag: "Party Pack Deal 🥤",
    imageUrl: "https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 48,
    name: "Real Activ Coconut Water - Fresh & Natural",
    brand: "Real Activ",
    category: "Beverages",
    price: 65.00,
    originalPrice: 80.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["200 ml pack", "400 ml pack"],
    selectedVariant: "200 ml pack",
    hasSpecialOffer: false,
  ...
  },
  {
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["200 g jar", "500 g jar"],
    selectedVariant: "200 g jar",
    hasSpecialOffer: true,
    dealTag: "Grow Strong 💪",
    imageUrl: "https://images.unsplash.com/photo-1517093602195-b40af9688f4a?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 51,
    name: "Lipton Yellow Label Premium Black Tea",
    brand: "Lipton",
    category: "Beverages",
    price: 95.00,
    originalPrice: 120.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["100 tea bags box", "250 g loose leaf"],
    selectedVariant: "100 tea bags box",
    hasSpecialOffer: false,
    imageUrl: "https://images.unsplash.com/photo-1571934811356-5cc061b6821f?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 52,
    name: "Paper Boat Aam Panna Raw Mango Drink",
    brand: "Paper Boat",
    category: "Beverages",
    price: 30.00,
    originalPrice: 40.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["250 ml pouch", "Pack of 4"],
    selectedVariant: "250 ml pouch",
    hasSpecialOffer: true,
  ...
  },
  {
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["1 kg pack", "2 kg pack"],
    selectedVariant: "1 kg pack",
    hasSpecialOffer: true,
    dealTag: "Protein Rich 💪",
    imageUrl: "https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 54,
    name: "Fortune Refined Soybean Cooking Oil",
    brand: "Fortune",
    category: "Grains",
    price: 155.00,
    originalPrice: 190.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["1 Litre bottle", "5 Litre jar"],
    selectedVariant: "1 Litre bottle",
    hasSpecialOffer: false,
    imageUrl: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 55,
    name: "Haldiram's Premium Roasted Chana Dal",
    brand: "Haldiram's",
    category: "Grains",
    price: 70.00,
    originalPrice: 90.00,
  ...
  {
    id: 57,
    name: "Tata Salt Iodised Premium Crystal Salt",
    brand: "Tata Salt",
    category: "Grains",
    price: 25.00,
    originalPrice: 32.00,
  ...
  {
    id: 58,
    name: "Organic Masoor Red Lentils - Unpolished",
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["500 g pack", "1 kg pack"],
    selectedVariant: "500 g pack",
    hasSpecialOffer: true,
    dealTag: "Certified Organic 🌿",
    imageUrl: "https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 59,
    name: "Rajdhani Moong Dal Yellow Split",
    brand: "Rajdhani",
    category: "Grains",
    price: 98.00,
    originalPrice: 125.00,
  ...
  {
    id: 60,
    name: "Everest Kitchen King Masala Blend",
    brand: "Everest",
    category: "Spices",
    price: 65.00,
    originalPrice: 85.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["100 g pack", "200 g pack"],
    selectedVariant: "100 g pack",
    hasSpecialOffer: true,
    dealTag: "Chef's Secret 👨‍🍳",
    imageUrl: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 61,
    name: "Kashmiri Red Chilli Powder - Vibrant Color",
    brand: "Catch",
    category: "Spices",
    price: 75.00,
    originalPrice: 95.00,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["100 g pack", "200 g pack", "500 g bulk"],
    selectedVariant: "100 g pack",
    hasSpecialOffer: false,
    imageUrl: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 62,
    name: "Organic Haldi / Turmeric Powder",
    brand: "24 Mantra Organic",
    category: "Spices",
    price: 55.00,
    originalPrice: 70.00,
  ...
  },
  {
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["100 g pack", "500 g tin"],
    selectedVariant: "100 g pack",
    hasSpecialOffer: false,
    imageUrl: "https://images.unsplash.com/photo-1609501675039-b8e00efa5b67?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 64,
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["1 Litre bottle", "5 Litre tin"],
    selectedVariant: "1 Litre bottle",
    hasSpecialOffer: true,
    dealTag: "Traditional Cold Press",
    imageUrl: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 65,
    name: "Premium Ceylon Cinnamon Sticks / Dalchini",
    brand: "Organic India",
    category: "Spices",
    price: 95.00,
    originalPrice: 125.00,
  ...
  },
  {
    ...
    deliveryTime: "10 MINS",
    isVeg: true,
    variants: ["0.5 g vial", "1 g vial"],
    selectedVariant: "0.5 g vial",
    hasSpecialOffer: true,
    dealTag: "Pure & Potent 🌸",
    imageUrl: "https://images.unsplash.com/photo-1625944525533-473f1a3d54e7?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: 67,
    name: "Parachute Coconut Oil - Pure & Natural",
    brand: "Parachute",
    category: "Spices",
    price: 125.00,
